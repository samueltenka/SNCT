...
namespace SNCT {
    class Finder {
        ...
        public static double sentence_relevance(String sentence, String[] query_words) { // returns number > -1.0
        ...
        public static SortedList<String, double> answer(String text, String query, int num) { // returns list of n best sentences
            String[] sentences = text.Split('.');                                             // (ordered by from least to most relevant)
            String[] query_words = query.Split(' ');

            SortedList<String, double> best_so_fars = new SortedList<String, double>();
