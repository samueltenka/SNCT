...
namespace SNCT
{
    ...
    public class Finder
    {
        ...
        { // returns list of n best sentences, ordered by from least to most relevant
            String[] sentences = get_sentences(text);
            String[] query_words = query.Split(' '); // TODO: lowercasify, but keep track of indices so can reverse
